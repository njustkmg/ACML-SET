...
from caption.data.datasets import fitment_caption
...
DATASET_CATALOGS = {'conceptual_captions': ConceptualCaptionsDataset,
                    ...
                    'fitment_caption': FitmentCaptionsDataset}
...
def make_dataloader(cfg, dataset=None, mode='train', distributed=False, num_replicas=None, rank=None,
    ...
    print(dataset.data_names) # ['image', 'boxes', 'im_info', 'text', 'relationship_label', 'mlm_labels', 'mvrc_ops', 'mvrc_labels']
