...
def parse_args():
    ...
    parser.add_argument('--cfg', type=str, help='path to config file', default='/home/whc/Desktop/fitment/code/VL-BERT-master/cfgs/pretrain/vis_attention_maps_coco.yaml')
    ...
    parser.add_argument('--save-dir', help='directory to save attention maps', type=str, default='./vl-bert_viz')
