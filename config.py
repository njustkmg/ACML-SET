...
_C.NETWORK.VLBERT.vocab_size = 21128
...
_C.NETWORK.VLBERT.visual_region_classes = 121
_C.NETWORK.VLBERT.position_padding_idx = -1

_C.NETWORK.DECODER = edict()
_C.NETWORK.DECODER.vocab_size = 21128
_C.NETWORK.DECODER.max_len = 100  
_C.NETWORK.DECODER.N_dec = 3
_C.NETWORK.DECODER.padding_idx = 0
